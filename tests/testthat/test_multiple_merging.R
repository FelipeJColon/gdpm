...
test_that("`getid` returns the correct time range", {
  ...
  expect_equal(
    range(getid(chickenpox, hepatitis, ili, dengue,
      range_cut = "shortest")$year),
    c(1980, 2010))
  ...
  expect_equal(
    range(getid(chickenpox, rubella, ili, dengue,
      range_cut = "longest")$year),
    c(2006, 2015))
...
test_that("`getid` returns the correct province name", {
  ...
  expect_equal(
    unique(getid(chickenpox, rubella, ili, dengue,
      range_cut = "longest")$province),
    c("An Giang", "Ba Ria - Vung Tau", "Bac Giang", "Bac Kan", "Bac Lieu",
      "Bac Ninh", "Ben Tre",  "Binh Dinh", "Binh Duong", "Binh Phuoc",
      "Binh Thuan", "Ca Mau", "Can Tho", "Cao Bang", "Da Nang", "Dak Lak",
      "Dak Nong", "Dien Bien", "Dong Nai", "Dong Thap", "Gia Lai", "Ha Giang",
      "Ha Nam", "Ha Noi", "Ha Tinh", "Hai Duong", "Hai Phong",
